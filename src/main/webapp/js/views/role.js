$(function () {
    ...
    var cmdObj = {
        ...
        save: function () {
            ...
            // 如果有id，说明是编辑；否则，是保存。
            if (idVal) {
                url = "/ssm-crm/role_update";
            } else {
                url = "/ssm-crm/role_save";
            }
        ...
        edit: function () {
            ...
            if (rowData) {
                ...
                options.url = "/ssm-crm/permission_queryByRid";
        ...
        del: function () {
            ...
            if (rowData) {
                ...
                $.messager.confirm("温馨提示", "您确定要删除这条数据吗？", function (yes) {
                    if (yes) {
                        $.get("/ssm-crm/role_delete?id=" + rowData.id, function (data) {
                            if (data.success) {
                                $.messager.alert("温馨提示", data.msg, "info", function () {
                                    // 刷新表格数据
                                    roleDatagrid.datagrid("reload");
