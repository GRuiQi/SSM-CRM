...
<head>
    ...
    <script type="text/javascript" src="${APP_PATH}/js/views/department.js"></script>
</head>
<body>
...
<div id="dep_datagrid_tb">
    <div>
        ...
        <a id="dep_datagrid_del" class="easyui-linkbutton" iconCls="icon-remove" plain="true" data-cmd="del">删除</a>
